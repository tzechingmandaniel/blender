"""Render side + 3/4 clay previews of v04_minor_details.blend into
04_renders/clay_renders. Uses Cycles with the placeholder materials so
the minor details read against the major parts."""
import bpy
import os
...
# Hide reference image, guides, BLK_ blockout, and the archive sub-collection
...
render_from("CAM_preview_3quarter", "v04_minor_details_3quarter.png")

side = bpy.data.objects.get("VIEW_side_modeling")
if side:
    side.data.type = "ORTHO"
    side.data.ortho_scale = 1.10
    render_from("VIEW_side_modeling", "v04_minor_details_side.png")
